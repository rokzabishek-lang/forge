> **Archived 2026-09-23.** This is the original architecture plan from 11 September 2026, kept because other documents and three source comments cite its section numbers (§1 Timeline IR, §2 three speeds, §3/§3b render tiers, §5 clip mining). Its build order is long finished; the current plan is `docs/PLAN.md` (Phase C) and the fix list is `docs/FIX.md`.
